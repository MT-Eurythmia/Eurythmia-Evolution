-- This file is copied from Pipeworks with only minimal changes.
		...
		minetest.register_node(data.name_base.."_"..state, {
			...
			on_construct = function(pos)
				...
				if data.eject_drops then
					inv:set_size("main", data.main_inv_size)
				end
			end,
...
if pipeworks.enable_node_breaker then
	...
	local name_base = "pw_like:nodebreaker"
	data = {
		name_base = name_base,
		...
		wield_inv_height = 1,
		formspec = "size[8,10;]"..
				"item_image[0,0;1,1;pw_like:nodebreaker_off]"..
				"label[1,0;Node Breaker]"..
				"list[current_name;pick;3.5,1;1,1;]"..
				"list[current_name;main;2.5,2.5;3,3;]"..
